...
function selects()
{
document.getElementById("sr").className = "selected";
  }
...
$sql = "SELECT * FROM srequest WHERE labId='$l'"; 
...
echo "<td><form action='fapprove.php' method='post' enctype='multipart/form-data'> 
