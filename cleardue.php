...
if($_POST['action'] == 'Clear Dues')
{
  ...
  $result = mysqli_query($con,$sql);
   ...
   $sql1 = "SELECT * FROM component WHERE compId = '$compId'";
...
//echo "$number";
   ...
   $sql2 = "UPDATE component SET number='$newNum' WHERE compId='$compId' LIMIT 1";
...
$mail->Body = "The request from  " .$roll. " for  comp: " .$compId. " with Quantity ".$number. " is accepted";
