...
$sql1 = "UPDATE dues SET number = '$upd' WHERE requestId = '$id'";
   ...
   $sql2 = "SELECT * FROM component WHERE compId = '$compId'";
   ...
   $sql3 = "UPDATE component SET number = '$num4' WHERE compId ='$compId'";
...
else
{
   ...
   $sql3 = "UPDATE component SET number = '$num3' WHERE compId ='$compId'";
   $result2 = mysqli_query($con,$sql3);}
